...
- 챌린지 기능은 `supabase/challenges_patch.sql`
...
- 납부/미납 버튼 정상
- 미납자 필터 정상
- 모바일용 이름 목록 붙여넣기 납부 처리 정상
- 운영 체크 카드의 미납 안내 복사 문구 정상
- CSV 다운로드 정상
- 연속 미납 경고 표시 정상
...
9. 포인트 챌린지
- 승인 회원 챌린지 제안 가능
- 운영진 모집 시작/진행/인증 확인/판정/정산 가능
- 카톡 인증 태그와 정산 결과 표시 정상
- 운영진 월간 포인트/배지 수동 지급 정상
